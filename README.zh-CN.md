...
- **预设保存 / 分享** — 把当前的"风格"（相框 / 模板 / 边距 / 阴影 / 圆角 / 签名）存成命名预设，或复制分享链接（`#p=<code>`）发给朋友
- **7 个开箱即用的精选预设** —— 一键起步：35mm 胶片真 / 杂志编辑 / 哈苏致敬 / Leica 侧栏 / Kodak 专业 / 宝丽来经典 / Frosted 经典；以 chip 形式陈列在「我的预设」上方，点开即用、随手二次创作、存成自己的 look
